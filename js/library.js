...
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).SplitType = e();
}(this, function () {
  "use strict";
  ...
  !function () {
    ...
    function n() {
      ...
      if (t) for (o || t.removeChild(this); o--;) {
        var i = n[o];
        "object" != _typeof(i) ? i = this.ownerDocument.createTextNode(i) : i.parentNode && i.parentNode.removeChild(i), o ? t.insertBefore(this.previousSibling, i) : t.replaceChild(i, this);
      }
    }
...
function customizeSelect(self, attribuites) {
  ...
  var selectContent = $this.find("[selected]").length == 0 ? $this.children("option").eq(0).html() : $this.find("[selected]").html();
  $styledSelect.html((attribuites.filter ? '<input class="input-item" type="text"/> <div class="input-text"' : "<div ") + 'style="height: ' + attribuites.height + ";vertical-align: " + attribuites.align + "; display: " + attribuites.display + ';">' + selectContent + "</div>");
  ...
  for (var i = 0; i < numberOfOptions; i++) {
    $("<li />", {
      html: '<div style="height: ' + attribuites.height + ";vertical-align: " + attribuites.align + "; display: " + attribuites.display + ';">' + $this.children("option").eq(i).html() + "</div>",
  ...
  $styledSelect.find("input").on("keyup", function (event) {
    $(this).parents(".select").find(".options li").each(function (index, elem) {
